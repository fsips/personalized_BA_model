function [dx] = BA_human_model_R2_TRIPLO_transit_ode_c(t, x, p, u)
...
curr_GI_reflex_GB1_raw = (t - tau)  / pow(GIr_beta_GB1,2.0) * exp(-1*pow((t - tau) , 2.0)  / (2*pow(GIr_beta_GB1,2.0)));
curr_GI_reflex_GB1_max = GIr_beta_GB1 / pow(GIr_beta_GB1,2.0) * exp(-1*pow(GIr_beta_GB1,2.0) /(2*pow(GIr_beta_GB1,2.0)));
curr_GI_reflex_GB2_raw = (t - tau)  / pow(GIr_beta_GB2,2.0) * exp(-1*pow((t - tau) , 2.0)  / (2*pow(GIr_beta_GB2,2.0)));
curr_GI_reflex_GB2_max = GIr_beta_GB2 / pow(GIr_beta_GB2,2.0) * exp(-1*pow(GIr_beta_GB2,2.0) /(2*pow(GIr_beta_GB2,2.0)));
curr_GI_reflex_GB = 1.0 +GIr_delta_GB1 *  curr_GI_reflex_GB1_raw / curr_GI_reflex_GB1_max +GIr_delta_GB2 *  curr_GI_reflex_GB2_raw / curr_GI_reflex_GB2_max; 
curr_GI_reflex_SI_raw = (t - tau)  / pow(GIr_beta_SI,2.0) * exp(-1*pow((t - tau) , 2.0)  / (2*pow(GIr_beta_SI,2.0)));
curr_GI_reflex_SI_max = GIr_beta_SI / pow(GIr_beta_SI,2.0) * exp(-1*pow(GIr_beta_SI,2.0) /(2*pow(GIr_beta_SI,2.0)));
curr_GI_reflex_SI = 1.0 +GIr_delta_SI *  curr_GI_reflex_SI_raw / curr_GI_reflex_SI_max; 

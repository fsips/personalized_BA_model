function [mStruct, filename] = generate_ode_mex(tag, folder, c, p, o, L, c_loc, p_loc, depen)
...
if is_full
    filename        = [tag, '_full_ode_c'];
else
    filename        = [tag, '_transit_ode_c'];
end
...
mStruct = generate_body(f, prefix, c, p, o, L, c_loc, p_loc, depen, 1);
...
% Updated to new model version on 29-08-2016
